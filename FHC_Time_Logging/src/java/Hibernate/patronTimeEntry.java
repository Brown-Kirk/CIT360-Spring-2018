 ...
 * @author reddo
 */
public class patronTimeEntry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int loginAction = parseInt(request.getParameter("loginAction"));
            Controller controller = new Controller();
            String message = controller.addNewLogInTime(patronId, loginAction);
            out.println(message);
